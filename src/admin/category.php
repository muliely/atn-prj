<script>
	function delCat(){
		var confirmBox = confirm("Are you sure to delete this category?");
		return confirmBox;
	}
</script>
<?php
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div id="toolbar" class="btn-group">
            <a href="admin.php?page_layout=add_category" class="btn btn-success">
                <i class="glyphicon glyphicon-plus"></i> Add new brand
            </a>
        </div>
		<div class="row">
			<div class="col-md-12">
							...
							<div class="panel-body">
								<table 
									...
									<tbody>
										...
										$sql_cat_list = "select * from category order by cat_id limit $f_key, $row_per_page";
